...
@section('content')
    ...
    <table class="table table-bordered table-striped table-hover">
        <thead class="table-dark">
            <tr>
                {{-- Atur lebar kolom "No" menjadi lebih kecil --}}
                ...
                <th style="width: 15%;">Aksi</th> {{-- Beri sedikit lebar untuk kolom Aksi --}}
            </tr>
        </thead>
        <tbody>
            @foreach ($barangs as $key => $barang)
                <tr>
                    ...
                    {{-- Pastikan Tombol Aksi ada di dalam perulangan @foreach --}}
                    <td>
